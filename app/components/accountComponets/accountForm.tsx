...
export default function AccountForm() {
    ...
    return (
        <div>
            <div className="flex flex-col gap-10 bg-red-600 border-red-700 border-solid border-2  items-center h-screen justify-center pt-12" style={{ width: "500px", boxShadow: '0px 0px 10px 0px black' }}>
