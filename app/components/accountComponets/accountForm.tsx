...
const AccountForm: React.FC<AccountFormInterface> = ({ showForm, setShowForm }) => {
    ...
    return (
        <div>
                <div className="flex flex-col gap-5 bg-red-600 border-red-700 border-solid border-2 py-8 px-5 absolute top-14 z-50 rounded-2xl " style={{ left: '35vw', boxShadow: '0px 0px 10px 0px black' }}>
